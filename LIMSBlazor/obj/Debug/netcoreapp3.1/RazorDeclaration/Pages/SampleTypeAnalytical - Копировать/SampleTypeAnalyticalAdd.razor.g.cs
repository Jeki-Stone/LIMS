...
#nullable disable
#nullable restore
#line 1 "C:\Users\Иван\source\repos\LIMSBlazor\LIMSBlazor\Pages\SampleTypeAnalytical - Копировать\SampleTypeAnalyticalAdd.razor"
using LIMSBlazor.Data;

#line default
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/sampletype/sampletypeanalyticaladd/{SampleTypeId:int}")]
    public partial class SampleTypeAnalyticalAdd : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 40 "C:\Users\Иван\source\repos\LIMSBlazor\LIMSBlazor\Pages\SampleTypeAnalytical - Копировать\SampleTypeAnalyticalAdd.razor"
    ...
    protected async Task SampleTypeAnalyticalInsert()
    {
        if (sampletypeanalytical.AnalyticalServiceId == 0)
        {
            error = "Выберите аналитический сервис!";
            return;
        } else
        {
            error = null;
