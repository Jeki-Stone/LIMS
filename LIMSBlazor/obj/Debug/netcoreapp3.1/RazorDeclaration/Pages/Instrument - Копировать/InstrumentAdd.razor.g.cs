...
#nullable disable
#nullable restore
#line 1 "C:\Users\Иван\source\repos\LIMSBlazor\LIMSBlazor\Pages\Instrument - Копировать\InstrumentAdd.razor"
using LIMSBlazor.Data;

#line default
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/instrumentadd")]
...
#nullable restore
#line 68 "C:\Users\Иван\source\repos\LIMSBlazor\LIMSBlazor\Pages\Instrument - Копировать\InstrumentAdd.razor"
    ...
    protected async Task InstrumentInsert()
    {
        if (instrument.TestMachTypeId == 0)
        {
            error1 = "Выберите тип оборудования!";
            return;
        }

        if (instrument.LabId == 0)
        {
