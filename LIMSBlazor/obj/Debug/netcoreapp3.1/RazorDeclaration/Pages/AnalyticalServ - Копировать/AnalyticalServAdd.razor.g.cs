...
namespace LIMSBlazor.Pages.AnalyticalServ___Копировать
{
    #line hidden
    using System;
...
#nullable disable
#nullable restore
#line 1 "C:\Users\Иван\source\repos\LIMSBlazor\LIMSBlazor\Pages\AnalyticalServ - Копировать\AnalyticalServAdd.razor"
using LIMSBlazor.Data;

#line default
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/analyticalservadd")]
    public partial class AnalyticalServAdd : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 60 "C:\Users\Иван\source\repos\LIMSBlazor\LIMSBlazor\Pages\AnalyticalServ - Копировать\AnalyticalServAdd.razor"
    ...
    protected async Task AnalyticalServInsert()
    {
        if (analyticalserv.CategoryId == 0)
        {
            error1 = "Выберите Категорию!";
            return;
        }

        if (analyticalserv.UnitId == 0)
        {
            error2 = "Выберите Ед. Измерения!";
            return;
        }
