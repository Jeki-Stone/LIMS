...
#nullable disable
#nullable restore
#line 1 "C:\Users\Иван\source\repos\LIMSBlazor\LIMSBlazor\Pages\InstrumentType\InstrumentAddEdit.razor"
...
#nullable restore
#line 67 "C:\Users\Иван\source\repos\LIMSBlazor\LIMSBlazor\Pages\InstrumentType\InstrumentAddEdit.razor"
    ...
    protected async Task InstrumentSave()
    {
        if (instrument.Id == 0)
        {
            ...
            await InstrumentService.InstrumentInsert(instrument);
        }
        else
        {
            // Update is id > 0
